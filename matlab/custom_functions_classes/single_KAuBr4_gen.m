function KAuBr4 = single_KAuBr4_gen(KAuBr4_coords,rel_pos,flat_CNT,steps,dopant_CNT_dist)
%single_KAuBr4_gen Generates one KAuBr4 molecule for band structure calcs
